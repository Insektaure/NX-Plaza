...
namespace {
    ...
    const Translation kEntries[] = {
        ...
        { "Trades run while the app is open - the other console does not have to be",
            "Les échanges se font tant que l'app est ouverte - l'autre console "
        ...
        { "On, for anybody the Plaza Dash minigame makes queasy: the background "
          ...
          "full parallax",
            ...
            "parallaxe complète" },
        { "Sound", "Son" },
        { "Short tones for what happens, and no music: nothing plays in the "
          "background. How loud they are is the console's own volume.",
            "De brefs sons pour ce qui arrive, et pas de musique : rien ne joue "
            "en fond. Le volume, c'est celui de la console." },
        { "The interface", "L'interface" },
        { "The tick as the cursor moves, and a note for yes and for no. This is "
          "the half that sounds several times a second while you are reading a "
          "list",
            "Le tic du curseur, et une note pour oui et pour non. C'est la "
            "moitié qui sonne plusieurs fois par seconde quand vous lisez une "
            "liste" },
        { "Everything else", "Tout le reste" },
        { "A pass arriving, a coin, a trophy, and what happens in the games and "
          "the quest",
            "Une carte qui arrive, une pièce, un trophée, et ce qui se passe "
            "dans les jeux et la quête" },
        ...
        { "Your identity, your pass, your collection and the quest, into backup/ "
          "on this card",
            "Votre identité, votre carte, votre collection et la quête, dans "
            "backup/ sur cette carte" },
        ...
        { "%s hits %s for %d",
            "%s frappe %s pour %d" },
        { "%s sweeps the whole party",
            "%s balaie toute l'équipe" },
        { "what happened", "ce qui s'est passé" },
        { "%u shadows behind you", "%u ombres derrière vous" },
        { "No shadow has fallen yet", "Aucune ombre n'est encore tombée" },
        { "Not met yet", "Pas encore rencontrée" },
        { "next", "suivante" },
        { "the shadows", "les ombres" },
        { "auto equip", "équipement auto" },
        { "%s is equipped", "%s est équipé" },
        { "One peg changed.",
            "Un emplacement a changé." },
        { "%d pegs changed.",
            "%d emplacements ont changé." },
        { "Nothing to change",
            "Rien à changer" },
        { "They already have the best of everything nobody else is wearing.",
            "Ils ont déjà le meilleur de ce que personne d'autre ne porte." },
        { "newest first", "les plus récents" },
        { "best first", "les meilleurs d'abord" },
        { "everything in the bag",
            "tout le sac" },
        { "only what goes on the %s peg",
            "seulement ce qui va sur l'emplacement %s" },
        { "Throw away %zu %s pieces from the %s peg?",
            "Jeter %zu pièces de rang %s de l'emplacement %s ?" },
        { "clear a rank",
            "vider un rang" },
        ...
        { "Throw away %zu %s pieces?",
            "Jeter %zu pièces de rang %s ?" },
        { "Nothing worn and nothing locked goes with them. It does not come back.",
            "Rien de porté ni de verrouillé ne part avec. Cela ne revient pas." },
        { "Nothing to throw away",
            "Rien à jeter" },
        { "Nothing of that rank is spare: what you have is worn, locked, or not there at all.",
            "Rien de ce rang n'est en trop : ce que vous avez est porté, verrouillé, ou absent." },
        { "resets in %u days",
            "réinitialisation dans %u jours" },
        { "resets in %u hours",
            "réinitialisation dans %u heures" },
        { "resets within the hour",
            "réinitialisation dans l'heure" },
        { "Climb from %d",
            "Grimper depuis %d" },
        { "where to start",
            "où commencer" },
        { "Those floors have already paid, and the blessings start again.",
            "Ces étages ont déjà payé, et les bénédictions repartent de zéro." },
        { "look closer",
            "regarder de plus près" },
        { "what falls here",
            "ce qui tombe ici" },
        { "One floor in two leaves something behind.",
            "Un étage sur deux laisse quelque chose." },
        { "%u more health and %u more attack than the floor below",
            "%u points de vie et %u d'attaque de plus que l'étage du dessous" },
        { "never",
            "jamais" },
        { "The party falls", "L'équipe tombe" },
        { "nothing this time", "rien cette fois" },
        { "next floor", "étage suivant" },
        { "pick again", "choisir à nouveau" },
        ...
        { "the bag", "le sac" },
        { "everything", "tout" },
        { "from floor %u", "de l'étage %u" },
        { "worn by %s", "porté par %s" },
        { "Somebody who has gone", "Quelqu'un qui n'est plus là" },
        { "Nothing here yet. The tower is where it comes from.",
            "Rien pour l'instant. C'est la tour qui en donne." },
        { "Somebody is wearing that", "Quelqu'un le porte" },
        { "Take it off first, then throw it away.",
            "Retirez-le d'abord, puis jetez-le." },
        { "Take it off in the gear screen first.",
            "Retirez-le d'abord depuis l'écran d'équipement." },
        { "lock", "verrouiller" },
        { "unlock", "déverrouiller" },
        { "That one is locked", "Celui-là est verrouillé" },
        ...
        { "worn", "porté" },
        { "wear it", "équiper" },
        { "what would fit", "ce qui irait" },
        { "take it off", "retirer" },
        { "back to the pegs", "retour aux emplacements" },
        { "throw away", "jeter" },
        ...
        { "Everything in it is worn or locked, so what fell stayed on the floor.",
            "Tout dedans est porté ou verrouillé, alors ce qui est tombé est resté par terre." },
        ...
        { "The party hits a fifth harder.",
            "L'équipe frappe un cinquième plus fort." },
        { "Ironclad", "Cuirassé" },
        { "The party takes a fifth less.",
            "L'équipe encaisse un cinquième de moins." },
        { "Hale", "Vigueur" },
        { "A fifth more health, and it fills now.",
            "Un cinquième de vie en plus, et elle se remplit." },
        { "Fleet", "Prestesse" },
        { "Everybody is three quicker.",
            "Tout le monde gagne trois en vitesse." },
        { "Reckless", "Téméraire" },
        { "A third harder, and a quarter softer.",
            "Un tiers plus fort, un quart plus fragile." },
        { "Bulwark", "Rempart" },
        { "A third tougher, and a fifth weaker.",
            "Un tiers plus solide, un cinquième plus faible." },
        { "Keen edge", "Tranchant" },
        { "Telling blows land three times as often.",
            "Les coups décisifs tombent trois fois plus souvent." },
        { "Second wind", "Second souffle" },
        { "The first to fall gets up once, at half.",
            "Le premier à tomber se relève une fois, à la moitié." },
        { "Rally", "Ralliement" },
        { "Each one who falls makes the rest hit a fifth harder.",
            "Chaque chute fait frapper les autres un cinquième plus fort." },
        { "Momentum", "Élan" },
        { "The party hits a twentieth harder for every floor from here.",
            "L'équipe frappe un vingtième plus fort par étage à partir d'ici." },
        { "Last stand", "Baroud d'honneur" },
        { "Alone, the last one standing hits twice as hard.",
            "Seul, le dernier debout frappe deux fois plus fort." },
        { "Deep breath", "Grande inspiration" },
        { "Twice as much wind back between floors.",
            "Deux fois plus de souffle entre les étages." },
        { "Battle rhythm", "Cadence" },
        { "Everybody starts each floor with their wind full.",
            "Chacun commence chaque étage avec son souffle au maximum." },
        { "Cheap tricks", "Bottes secrètes" },
        { "Specials cost four instead of six.",
            "Les spéciales coûtent quatre au lieu de six." },
        { "Long watch", "Longue garde" },
        { "Standing in front covers the sweep as well.",
            "Se mettre devant couvre aussi le balayage." },
        { "Mending hands", "Mains guérisseuses" },
        { "The Mender heals half again, and steps in sooner.",
            "Le soigneur rend moitié plus, et intervient plus tôt." },
        { "Bright spark", "Étincelle vive" },
        { "The Spark takes twice as much off the shadow's arm.",
            "L'éclat retire deux fois plus de force au bras de l'ombre." },
        { "Scavenger", "Glaneur" },
        { "The shadow leaves something four times in five.",
            "L'ombre laisse quelque chose quatre fois sur cinq." },
        { "The stair offers you something",
            "L'escalier vous propose quelque chose" },
